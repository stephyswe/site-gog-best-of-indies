export const ItemXeonauts = () => (
  <div
    className="product-tile
            has-discount
        "
    ng-class="{'has-discount': tile.data.price.discountPercentage > 0}"
    product-tile-id={1412583633}
    product-tile-modifier=""
    gog-track-event="{ event: 'smallSpots' }"
    data-product_grid="small-spot__c0e959e2-2955-11ee-8dde-fa163eebc216"
    small-spot=""
    track-add-to-cart-category="mainPage"
    track-add-to-cart-action="clickTile"
    track-add-to-cart-label="addToCart"
    track-add-to-cart-price="299.20"
    track-add-to-cart-title="Xenonauts 2"
    track-add-to-cart-id={1412583633}
    data-is-customised="true"
    section-id="small_spot"
    data-context="SMALL_SPOTS"
  >
    <a
      className="product-tile__content js-content"
      href="/en/game/xenonauts_2"
      ng-href="/en/game/xenonauts_2"
    >
      ...
      >
        <picture className="product-tile__cover-picture js-cover-image">
          <source
            ...
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_304_2x.webp
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_304.webp
1x"
          />
          <source
            type="image/webp"
            ...
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_195_2x.webp
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_195.webp
1x"
          />
          <source
            type="image/webp"
            ...
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_hover_398_2x.webp
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_hover_398.webp
1x"
          />
          <source
            type="image/webp"
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_256_2x.webp
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_256.webp
1x"
          />
          <source
            type="image/jpeg"
            media="(max-width: 320px)"
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_304_2x.jpg
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_304.jpg
1x"
          />
          <source
            type="image/jpeg"
            media="(max-width: 414px)"
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_195_2x.jpg
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_195.jpg
1x"
          />
          <source
            type="image/jpeg"
            media="(max-width: 749px)"
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_hover_398_2x.jpg
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_hover_398.jpg
1x"
          />
          <source
            type="image/jpeg"
            srcSet="
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_256_2x.jpg
2x,
                //images-4.gog-statics.com/d698889ec03175f26d5283f6d0be6d078a3c8cd4963258922abcba1bc3feca5d_product_tile_256.jpg
1x"
          />
